...
export const DashboardPage: React.FC = () => {
    ...
    useEffect(() => {
        if (datasetId) {
            ...
            // If no ID in URL but datasets exist, pick the first one
            // navigate(`/dashboard/${datasets[0].id}`, { replace: true });
        }
    }, [datasetId, datasets]);
    ...
    if (!selectedDataset && !loading) {
        return (
            <div className="p-12 text-center space-y-6">
                ...
                <h2 className="text-2xl font-bold text-slate-400">No Dataset Selected</h2>
                <button onClick={() => navigate('/upload')} className="text-blue-500 hover:underline">Go to Upload</button>
            </div>
        );
    }
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Column Inventory */}
                <div className="lg:col-span-2 bg-slate-900/40 border border-white/5 rounded-3xl overflow-hidden flex flex-col min-h-[500px]">
                    ...
                    <div className="flex-1 overflow-auto custom-scrollbar p-6">
                        <table className="w-full text-left">
                            <thead>
                                <tr className="text-slate-500 text-xs font-bold uppercase tracking-widest border-b border-white/5 pb-4">
                    ...
                    <div className="bg-slate-900/40 border border-white/5 p-6 rounded-3xl">
                        ...
                        <div className="flex justify-center gap-8 mt-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-slate-400">Categorical</span>
                            </div>
                        </div>
                    </div>
